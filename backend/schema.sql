...
CREATE TABLE IF NOT EXISTS users (
  ...
  role ENUM('ADMIN', 'HOD', 'STAFF', 'FACULTY') NOT NULL DEFAULT 'FACULTY',
...
-- Hash: $2a$10$rZ7qHqYQX6Y6JZ4gX0KW4OqhqN3K4X6Y6Z4gX0KW4OqhqN3K4X6Y6
INSERT INTO users (name, email, password_hash, role, department, status) 
VALUES ('Admin User', 'admin@test.com', '$2a$10$rZ7qHqYQX6Y6JZ4gX0KW4OqhqN3K4X6Y6Z4gX0KW4OqhqN3K4X6Y6', 'ADMIN', 'IT', 'ACTIVE')
